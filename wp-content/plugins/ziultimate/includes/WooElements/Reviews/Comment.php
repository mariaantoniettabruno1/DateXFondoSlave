 ...
 */
class Comment extends UltimateElements {
    public function get_type() {
		return 'zu_review_comment';
	}

	public function get_name() {
		return __( 'Reviewer Comment', 'ziultimate' );
	}

	public function get_keywords() {
		return [ 'review comment', 'comment', 'reviewer comment' ];
	}
    ...
    public function options( $options ) {
		if( ! License::has_valid_license() ) {
			$title = $this->get_name();
			$description = 'With this tool you can display the reviewer comment.';
			$options->add_option(
				'el',
				[
					'type' 		=> 'html',
