...
class WCFeaturedProducts extends RepeaterProvider {
	public static function get_id() {
		return 'zu_featured_products';
	}

	public static function get_name() {
		return esc_html__( 'Featured Products', 'woocommerce' );
	}
	...
	public function get_schema() {
		$options_schema = new Options( 'zionbuilderpro/repeater_provider/zu_featured_products' );
