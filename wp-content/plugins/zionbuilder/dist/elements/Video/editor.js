(function(vue) {
  ...
  var Video_vue_vue_type_style_index_0_lang = "";
    ...
    setup(props) {
      ...
      function runScript() {
        ...
        if ((_a = window.zbScripts) == null ? void 0 : _a.video) {
          ...
          videoPlayer = new window.zbScripts.video(root2.value);
          videoPlayer.init();
        }
      }
      return {
  ...
  const _hoisted_1 = ["data-zion-video"];
  const _hoisted_2 = {
    ref: "videoPlayer",
    class: "zb-el-zionVideo-wrapper"
  };
  const _hoisted_3 = /* @__PURE__ */ vue.createElementVNode("div", { class: "znpb-el-zionVideo--bgOverlay" }, null, -1);
  const _hoisted_4 = {
    key: 0,
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ref: "root",
      "data-zion-video": $options.getElementOptions
    }, [
      vue.renderSlot(_ctx.$slots, "start"),
      vue.createElementVNode("div", _hoisted_2, null, 512),
      _hoisted_3,
      $props.options.use_image_overlay ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.imageOverlayTag), vue.mergeProps({ key: 0 }, $options.imageOverlayAttributes, {
        ref: "videoOverlay",
        class: "zb-el-zionVideo-overlay zb-el-zionVideo-overlay--inline",
        style: $options.getImageOverlayStyles
      }), {
        default: vue.withCtx(() => [
          $props.options.show_play_icon ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4, _hoisted_6)) : vue.createCommentVNode("", true)
        ]),
        _: 1
