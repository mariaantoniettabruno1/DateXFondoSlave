	...
	public static function get_strings() {
		return apply_filters(
			...
			[
				...
				'template_type'                            => esc_html__( 'TemplateFondo type', 'zionbuilder' ),
				'template_name'                            => esc_html__( 'TemplateFondo Name', 'zionbuilder' ),
				// TemplateFondo actions
				...
				'save_template'                            => __( 'Save TemplateFondo', 'zionbuilder' ),
				...
				'template'                                 => esc_html__( 'TemplateFondo', 'zionbuilder' ),
