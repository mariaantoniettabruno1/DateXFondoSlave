...
class Templates {
	...
	private function register_default_template_types() {
		$template_types = [
			[
				...
				'singular_name' => __( 'TemplateFondo', 'zionbuilder' ),
				'id'            => 'template',
			],
			[
	...
	private function register_post_type() {
		$labels = [
			'name'               => _x( 'Zion Templates', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'singular_name'      => _x( 'TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'add_new'            => _x( 'Add New', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'add_new_item'       => _x( 'Add New TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'edit_item'          => _x( 'Edit TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'new_item'           => _x( 'New TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'all_items'          => _x( 'All Templates', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'view_item'          => _x( 'View TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'search_items'       => _x( 'Search TemplateFondo', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'not_found'          => _x( 'No Templates found', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'not_found_in_trash' => _x( 'No Templates found in Trash', 'Zion TemplateFondo Library', 'zionbuilder' ),
			'menu_name'          => _x( 'Zion Templates', 'Zion TemplateFondo Library', 'zionbuilder' ),
		];
