...
class RelazioneIllustrativaDocument
{
    ...
    public function render()
    {
        ...
        <div id="relazioneIllustrativaDocument">
            ...
            <br/>
            <h6>Modulo 2 Illustrazione dell’articolato del contratto<br/>
            ...
            <ul class="a">
                ...
                <li>
                    ...
                    <table class="table-fondo">
                        ...
                        <?php if (self::checkOptionalValues('F294')): ?>
                            <tr>
                                <th scope="row">Indennità di servizio esterno – art. 56 quinquies CCNL 2018
                                    (Vigilanza)
                                </th>
                        ...
                        <?php if (self::checkOptionalValues('F212')): ?>
                            <tr>
                                <th scope="row">Indennità particolare compenso incentivante (personale unioni dei
                                    comuni)
                                </th>
            ...
            <br/>
            <br/>
            <h5>Sezione I - Destinazioni non disponibili alla contrattazione integrativa o comunque non regolate
                specificamente dal Contratto Integrativo sottoposto a certificazione</h5>
            ...
            <br/>
            <br/>
            <h5>Sezione VI - Attestazione motivata, dal punto di vista tecnico-finanziario, del rispetto di vincoli di
                carattere generale</h5>
            ...
            <h5>Sezione I - Esposizione finalizzata alla verifica che gli strumenti della contabilità
                economico-finanziaria dell’Amministrazione presidiano correttamente i limiti di spesa del Fondo nella
                fase programmatoria della gestione</h5>
            <br/>
            ...
            <h5>Sezione II -Esposizione finalizzata alla verifica a consuntivo che il limite di spesa del Fondo
                dell'anno precedente risulta rispettato</h5>
            ...
            <br/>
            <h5>Sezione III – Verifica delle disponibilità finanziarie dell'Amministrazione ai fini della copertura
                delle diverse voci di destinazione del Fondo</h5>
            <br/>
