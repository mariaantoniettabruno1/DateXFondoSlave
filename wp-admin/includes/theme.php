 ...
 *              'Full Width TemplateFondo', and 'Post Formats' features.
 ...
 * @since 5.8.1 Added 'TemplateFondo Editing' feature.
...
function get_theme_feature_list( $api = true ) {
	...
	$features = array(
		...
		__( 'Features' ) => array(
			...
			'full-width-template'   => __( 'Full Width TemplateFondo' ),
			'post-formats'          => __( 'Post Formats' ),
			'sticky-post'           => __( 'Sticky Post' ),
			'template-editing'      => __( 'TemplateFondo Editing' ),
