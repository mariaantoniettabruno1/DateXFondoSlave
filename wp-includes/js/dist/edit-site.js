  ...
  return async _ref6 => {
    ...
    try {
      ...
      if (allowUndo) {
        ...
        registry.dispatch(external_wp_notices_namespaceObject.store).createSuccessNotice((0,external_wp_i18n_namespaceObject.__)('TemplateFondo reverted.'), {
          type: 'snackbar',
          actions: [{
      ...
      const errorMessage = error.message && error.code !== 'unknown_error' ? error.message : (0,external_wp_i18n_namespaceObject.__)('TemplateFondo revert failed. Please reload.');
      registry.dispatch(external_wp_notices_namespaceObject.store).createErrorNotice(errorMessage, {
        type: 'snackbar'
      });
    }
...
/**
 * @typedef {'template'|'template_type'} TemplateType TemplateFondo type.
 */
 ...
 * @param {Object} state Global application state.
 *
 * @return {TemplateType?} TemplateFondo type.
 */
 ...
 *
 * @param {Object} state Global application state.
 * @return {Array} TemplateFondo parts and their blocks in an array.
 */
...
function DocumentActions(_ref) {
  ...
  if (!entityTitle) {
    return (0,external_wp_element_namespaceObject.createElement)("div", {
      className: "edit-site-document-actions"
    }, (0,external_wp_i18n_namespaceObject.__)('TemplateFondo not found'));
  }
...
const SettingsHeader = _ref => {
  ...
  const [templateAriaLabel, templateActiveClass] = sidebarName === SIDEBAR_TEMPLATE ? // translators: ARIA label for the TemplateFondo sidebar tab, selected.
  [(0,external_wp_i18n_namespaceObject.__)('TemplateFondo (selected)'), 'is-active'] : // translators: ARIA label for the TemplateFondo Settings Sidebar tab, not selected.
  [(0,external_wp_i18n_namespaceObject.__)('TemplateFondo'), ''];
  ...
  return (0,external_wp_element_namespaceObject.createElement)("ul", null, (0,external_wp_element_namespaceObject.createElement)("li", null, (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
    ...
    "aria-label": templateAriaLabel // translators: Data label for the TemplateFondo Settings Sidebar tab.
    ,
    "data-label": (0,external_wp_i18n_namespaceObject.__)('TemplateFondo')
  }, // translators: Text label for the TemplateFondo Settings Sidebar tab.
  (0,external_wp_i18n_namespaceObject.__)('TemplateFondo'))), (0,external_wp_element_namespaceObject.createElement)("li", null, (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
...
const NavigationPanel = _ref2 => {
  ...
  return (// eslint-disable-next-line jsx-a11y/no-static-element-interactions
    (0,external_wp_element_namespaceObject.createElement)("div", {
      ...
      icon: symbol_filled,
      title: (0,external_wp_i18n_namespaceObject.__)('TemplateFondo Parts'),
...
function ConvertToTemplatePart(_ref) {
  ...
  const onConvert = async _ref2 => {
    ...
    createSuccessNotice((0,external_wp_i18n_namespaceObject.__)('TemplateFondo part created.'), {
      type: 'snackbar'
  ...
  }, (0,external_wp_i18n_namespaceObject.__)('Create TemplateFondo part'))), isModalOpen && (0,external_wp_element_namespaceObject.createElement)(CreateTemplatePartModal, {
    closeModal: () => {
...
function NavigateToLink(_ref) {
  ...
  return onClick && (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
    icon: edit,
    label: (0,external_wp_i18n_namespaceObject.__)('Edit Page TemplateFondo'),
    onClick: onClick
  });
}
...
function Editor(_ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, (0,external_wp_element_namespaceObject.createElement)(URLQueryController, null), isReady && (0,external_wp_element_namespaceObject.createElement)(external_wp_keyboardShortcuts_namespaceObject.ShortcutProvider, null, (0,external_wp_element_namespaceObject.createElement)(external_wp_coreData_namespaceObject.EntityProvider, {
    ...
    footer: blockEditorMode !== 'zoom-out' ? (0,external_wp_element_namespaceObject.createElement)(external_wp_blockEditor_namespaceObject.BlockBreadcrumb, {
      rootLabelText: (0,external_wp_i18n_namespaceObject.__)('TemplateFondo')
    }) : undefined,
    shortcuts: {
...
function AddCustomGenericTemplateModal(_ref) {
  ...
  const defaultTitle = (0,external_wp_i18n_namespaceObject.__)('Custom TemplateFondo');
...
function AddedBy(_ref6) {
  ...
  if (TEMPLATE_POST_TYPE_NAMES.includes(templateType)) {
    // TemplateFondo originally provided by a theme, but customized by a user.
    ...
    } // TemplateFondo originally provided by a plugin, but customized by a user.
    ...
    } // TemplateFondo was created from scratch, but has no author. Author support
...
function Table(_ref) {
  ...
  return (// These explicit aria roles are needed for Safari.
    ...
    (0,external_wp_element_namespaceObject.createElement)("table", {
      ...
      role: "columnheader"
    }, (0,external_wp_i18n_namespaceObject.__)('TemplateFondo')), (0,external_wp_element_namespaceObject.createElement)("th", {
      className: "edit-site-list-table-column",
      role: "columnheader"
