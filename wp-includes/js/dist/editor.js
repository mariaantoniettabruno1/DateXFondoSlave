 ...
 * @param {Array?} template Block TemplateFondo.
 */
...
function EntityTypeList(_ref) {
  ...
  if (name === 'wp_template_part') {
    entityLabel = 1 === count ? (0,external_wp_i18n_namespaceObject.__)('TemplateFondo Part') : (0,external_wp_i18n_namespaceObject.__)('TemplateFondo Parts');
