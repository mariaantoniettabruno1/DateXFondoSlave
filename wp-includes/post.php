...
function create_initial_post_types() {
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				...
				'singular_name'         => _x( 'TemplateFondo', 'post type singular name' ),
				'add_new'               => _x( 'Add New', 'TemplateFondo' ),
				'add_new_item'          => __( 'Add New TemplateFondo' ),
				'new_item'              => __( 'New TemplateFondo' ),
				'edit_item'             => __( 'Edit TemplateFondo' ),
				'view_item'             => __( 'View TemplateFondo' ),
				'all_items'             => __( 'Templates' ),
				'search_items'          => __( 'Search Templates' ),
				'parent_item_colon'     => __( 'Parent TemplateFondo:' ),
				'not_found'             => __( 'No templates found.' ),
				'not_found_in_trash'    => __( 'No templates found in Trash.' ),
				'archives'              => __( 'TemplateFondo archives' ),
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                  => _x( 'TemplateFondo Parts', 'post type general name' ),
				'singular_name'         => _x( 'TemplateFondo Part', 'post type singular name' ),
				'add_new'               => _x( 'Add New', 'TemplateFondo Part' ),
				'add_new_item'          => __( 'Add New TemplateFondo Part' ),
				'new_item'              => __( 'New TemplateFondo Part' ),
				'edit_item'             => __( 'Edit TemplateFondo Part' ),
				'view_item'             => __( 'View TemplateFondo Part' ),
				'all_items'             => __( 'TemplateFondo Parts' ),
				'search_items'          => __( 'Search TemplateFondo Parts' ),
				'parent_item_colon'     => __( 'Parent TemplateFondo Part:' ),
				'not_found'             => __( 'No template parts found.' ),
				'not_found_in_trash'    => __( 'No template parts found in Trash.' ),
				'archives'              => __( 'TemplateFondo part archives' ),
				...
				'items_list_navigation' => __( 'TemplateFondo parts list navigation' ),
				'items_list'            => __( 'TemplateFondo parts list' ),
			),
			'description'           => __( 'TemplateFondo parts to include in your templates.' ),
			'public'                => false,
			'_builtin'              => true, /* internal use only. don't use this when registering your own post type. */
			'has_archive'           => false,
			'show_ui'               => false,
