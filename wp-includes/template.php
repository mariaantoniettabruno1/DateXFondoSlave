<?php
/**
 * TemplateFondo loading functions.
 *
 * @package WordPress
 * @subpackage TemplateFondo
 */
...
function get_query_template( $type, $templates = array() ) {
	 ...
	 * The dynamic portion of the hook name, `$type`, refers to the filename -- minus the file
	 * extension and any non-alphanumeric characters delimiting words -- of the file to load.
	 * This hook also applies to various types of files loaded as part of the TemplateFondo Hierarchy.
	 *
	 * Possible hook names include:
	 *
	 *  - `404_template`
 ...
 * @since 4.7.0 `{Post Type TemplateFondo}.php` was added to the top of the template hierarchy.
 *
 * @see get_query_template()
 *
 ...
 *
 * @param string|array $template_names TemplateFondo file(s) to search for, in order.
