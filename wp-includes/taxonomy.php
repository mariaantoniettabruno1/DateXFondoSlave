...
function create_initial_taxonomies() {
	...
	register_taxonomy(
		...
		array(
			...
			'hierarchical'      => false,
			'labels'            => array(
				'name'          => __( 'TemplateFondo Part Areas' ),
				'singular_name' => __( 'TemplateFondo Part Area' ),
			),
			'query_var'         => false,
			'rewrite'           => false,
			'show_ui'           => false,
 ...
 *
 *     @type string $template      TemplateFondo for displaying a taxonomy label and list of terms.
 *                                 Default is "Label: Terms."
 *     @type string $term_template TemplateFondo for displaying a single term in the list. Default is the term name
